...
MODULES                 = Buck_BLDC_2023a_4_acc.c Buck_BLDC_2023a_4_acc_data.c rtGetInf.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\Buck_BLDC_2023a_4_acc.mexw64
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:Buck_BLDC_2023a_4_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = Buck_BLDC_2023a_4_acc.mexw64
MODELREF_LINK_LIBS        = 
...
Buck_BLDC_2023a_4_acc.obj : $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\Buck_BLDC_2023a_4_acc.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\Buck_BLDC_2023a_4_acc.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\Buck_BLDC_2023a_4_acc.c

Buck_BLDC_2023a_4_acc_data.obj : $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\Buck_BLDC_2023a_4_acc_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\Buck_BLDC_2023a_4_acc_data.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\Buck_BLDC_2023a_4_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\rtGetInf.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\rt_nonfinite.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\rt_nonfinite.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\Buck_BLDC_2023a_4\rt_nonfinite.c
